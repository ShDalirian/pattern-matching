...
### example 1:
<kbd>original image is:!["original image"](initial_img.jpg)<br />
pattern is![pattern image](pattern1.jpg)<br />
detected image is![detected pattern image](BGR_detected.jpg)<kbd /><br />
